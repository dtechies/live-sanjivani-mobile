...
export function Calories(props) {
  return (
    <Svg
      ...
      <Path
        id="Path_1096"
        d="M700.943,629.579a.979.979,0,0,0-.3.723.724.724,0,0,0,.228.556.883.883,0,0,0,.619.211,1.661,1.661,0,0,0,.888-.239,1.693,1.693,0,0,0,.534-.555v-1.014h-1.075A1.24,1.24,0,0,0,700.943,629.579Z"
        fill="#3acfd5"
        transform="translate(-681.443 -612.021)"
        data-name="Path 1096"
      />
    </Svg>
  );

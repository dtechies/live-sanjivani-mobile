...
export function Address(props) {
  return (
    <Svg
      ...
      id="Group_5"
      width={props.width}
      viewBox="0 0 13.802 17.633"
      data-name="Group 5">
      <G id="Group_4" data-name="Group 4">
        <G id="noun_Map_2404959">
          <G id="Group_24" data-name="Group 24">
            <G id="Group_23" data-name="Group 23">
              <G id="Group_21" data-name="Group 21">
                <Path
                  id="Path_222"
                  d="M86.8,48.7h0a.392.392,0,0,1-.333-.185,34.938,34.938,0,0,0-2.622-3.466c-.624-.76-1.269-1.546-1.838-2.317-.969-1.314-2.082-3.043-2.082-4.765a6.9,6.9,0,0,1,13.8,0c0,1.845-1.182,3.681-2.955,5.871-.311.384-.637.775-.951,1.154a33.921,33.921,0,0,0-2.688,3.523A.392.392,0,0,1,86.8,48.7Zm.025-16.849a6.123,6.123,0,0,0-6.116,6.116c0,1.165.595,2.491,1.929,4.3.557.755,1.2,1.533,1.813,2.285.82,1,1.664,2.026,2.349,3.038.707-1.042,1.575-2.086,2.418-3.1.313-.376.637-.765.945-1.146,1.669-2.06,2.781-3.763,2.781-5.378A6.124,6.124,0,0,0,86.823,31.847Z"
                  fill={props.fill}
                  transform="translate(-79.923 -31.063)"
                  data-name="Path 222"
                />
              </G>
              <G
                id="Group_22"
                transform="translate(3.258 3.178)"
                data-name="Group 22">
                <Path
                  id="Path_223"
                  ...
                  fill={props.fill}
                  transform="translate(-163.052 -112.148)"
                  data-name="Path 223"
                />
              </G>
            </G>
